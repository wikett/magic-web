<template>
  <main class="isolate">
    <!-- Hero section -->
    <div
      class="relative isolate -z-10 overflow-hidden bg-gradient-to-b from-indigo-100/20 pt-16"
    >
      <div
      ...
      <div class="mx-auto max-w-7xl px-6 sm:py-8 lg:px-8">
        ...
        >
          ...
          <div
            ...
            v-html="data.authorsDescription"
          ></div>
          <img
            src="/img/autor.webp"
            alt="Autores"
            class="mt-10 aspect-[1/1] w-full max-w-lg rounded-2xl object-cover sm:mt-16 lg:mt-0 lg:max-w-none xl:row-span-2 xl:row-end-2 xl:mt-36"
          />
        </div>
      </div>
      <div
      ...
      <div class="mx-auto max-w-7xl py-20 sm:px-6 sm:py-20 lg:px-8">
        ...
        >
          ...
          <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
            Échale un vistazo a nuestro calendario con todos los eventos
            astronómicos para este 2024
          </p>
          <div class="mt-10 flex items-center justify-center gap-x-6">
            <a
              href="/calendario-astronomico/2024/eventos-astronomicos-2024"
    ...
    <div class="mx-auto mt-8 max-w-7xl px-6 lg:px-8">
      ...
      >
        <ThumbArticle
          v-for="item in articles.data._rawValue"
          :key="item.url"
          :post="item"
        />
    ...
    <!-- Logo cloud -->
    <div
      v-if="data.amazon.length > 0"
      class="mx-auto mt-32 max-w-7xl sm:mt-40 sm:px-6 lg:px-8"
    >
      <div
        class="relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16"
      >
        ...
        <div
          ...
          :class="{
            [`grid-cols-${data.amazon.length}`]: data.amazon.length > 0,
          }"
        >
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <img
                  :src="data.categoryImages[1].image"
                  :alt="data.categoryImages[1].title"
    ...
    <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
          {{ data.traducciones[2].texto }} {{ data.category }}
        </h2>
        <p class="mt-6 text-base leading-7 text-gray-600">
          {{ data.traducciones[3].texto }}
        </p>
      </div>
      <div
      ...
      >
        <div
          v-for="item in data.datosCuriosos"
