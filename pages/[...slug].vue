        ...
        <div class="relative mx-auto max-w-2xl lg:max-w-4xl">
          ...
          >
            ...
            <use href="#b56e9dab-6ccb-4d32-ad02-6b4bb5d9bbeb" x="86" />
              ...
              <blockquote
                class="text-sm leading-8 text-gray-900 sm:text-xl sm:leading-9 lg:text-xl italic font-semibold"
              >
            ...
            <figcaption class="text-base lg:col-start-1 lg:row-start-3">
              <div class="font-semibold text-blue-900">
                <a href="/quienes-somos">{{ info.author }}</a>
              </div>
              ...
              <div class="mt-1 text-gray-500">
                Escrito para:
                <span class="text-indigo-400 italic">{{ info.domain }}</span>
              </div>
            </figcaption>
          </figure>
